#!/usr/bin/env python3
"""
Sartorius PMA WebSocket Server for Windows
...
from sartorius_scale_windows import SartoriusScale, SUPPORTED_SCALES
...
async def main():
    print("=" * 55)
    print("Sartorius Scale - Windows WebSocket Server")
    print("=" * 55)
    print()
